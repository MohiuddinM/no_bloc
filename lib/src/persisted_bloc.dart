...
abstract class AutoPersistedBloc<R, S> extends PersistedBloc<R, S> {
  AutoPersistedBloc({S initialState, tag}) : super(initialState: initialState, tag: tag, autoPersistence: true, recoverStateOnStart: true);
}
...
abstract class PersistedBloc<R, S> extends Bloc<R, S> {
  ...
  PersistedBloc({S initialState, this.tag, this.autoPersistence = false, this.recoverStateOnStart = false})
      : super(initialState: (autoPersistence && recoverStateOnStart) ? null : initialState) {
